...
#define	MEDICINE_TYPE_CIRCLE_BBOX_WIDTH		14
#define	MEDICINE_TYPE_CIRCLE_BBOX_HEIGHT	15
...
#define	MEDICINE_ANI_TYPE_PINK_CIRCLE	2
#define	MEDICINE_ANI_TYPE_BLACK_CIRCLE	3
